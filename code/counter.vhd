...
begin
	...
	counter_process : process(clk)
		...
		variable prescaler: std_logic_vector (22 downto 0) := (others=>'0');	-- Contador p/ redução da atualização de saída (~1 seg)
		variable maximum	: integer := 10;	-- Contador p/ redução da atualização de saída (~1 seg)
	begin
